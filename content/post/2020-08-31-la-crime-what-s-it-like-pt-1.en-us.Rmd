...
lacrime <- read.csv(file = "~/Desktop/Isaiah's Blog/blog/datasets/lacrime.csv")
...
img<-OpenImageR::readImage("~/Desktop/Isaiah's Blog/blog/figures/LA-crime/crime_vict_prop2pop.png")
imageShow(img)
...
knitr::kable(read.csv("~/Desktop/Isaiah's Blog/blog/datasets/vict2pop.csv"),'html',col.names = c("crime code", "crime description", "ethnicity","ethnic count","rate per 10k", "ethnic population","rank")) %>%
  kable_paper("hover", full_width = T) %>% 
  scroll_box(width = "100%", height = "500px") 
